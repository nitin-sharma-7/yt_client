...
function MainVideo() {
  ...
  const data = {
    ...
    snippet: {
      ...
      extraDescription:
        "The trailer is here. #GameofThrones The Final Season begins April 14 on HBOThe trailer is here. #GameofThrones The Final Season begins April 14 on HBOThe trailer is here. #GameofThrones The Final Season begins April 14 on HBOThe trailer is here. #GameofThrones The Final Season begins April 14 on HBOThe trailer is here. #GameofThrones The Final Season begins April 14 on HBOThe trailer is here. #GameofThrones The Final Season begins April 14 on HBO",
      thumbnails: {
        default: {
    ...
    comments: [
      {
        ...
        authorProfileImageUrl: "https://i.ytimg.com/vi/rlR4PJn8b8I/default.jpg",
      },
      {
    ...
    <div className="max-w-5xl mx-auto bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="mt-4 bg-gray-100 dark:bg-gray-800 rounded-xl p-3">
        <div className="flex space-x-3 text-sm text-gray-600 dark:text-gray-400 mb-2">
          ...
          <span>{new Date(data.snippet.publishedAt).toLocaleDateString()}</span>
        </div>
        ...
        {more ? <div>{data.snippet.extraDescription}</div> : ""}
